...
export default function Documentos({ usuario, filtroUnidadInicial, filtroEstadoInicial }) {
  ...
  const [filtroEstado, setFiltroEstado] = useState(filtroEstadoInicial ? [filtroEstadoInicial] : [])
