-- =====================================================================
-- Fix: get_ficha_activo() no incluía el id de la unidad en el objeto
-- "unidad" que devuelve. Por eso las tarjetas KPI de la ficha (OT abiertas,
-- Docs vencidos, Novedades pendientes) no podían filtrar al saltar a esos
-- módulos — mandaban un id vacío. Se agrega 'id', v_unidad.id.
-- =====================================================================
