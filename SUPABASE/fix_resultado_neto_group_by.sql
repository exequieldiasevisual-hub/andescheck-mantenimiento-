-- =====================================================================
-- Corrige get_resultado_neto: el reparto por centro de costo dividía por
-- una columna (cant_u.n) fuera de la suma sin agruparla, lo que Postgres
-- rechaza ("column must appear in the GROUP BY clause"). Se mueve la
-- división adentro del sum(), igual que ya se hacía para el reparto del
-- sueldo del chofer.
-- =====================================================================
