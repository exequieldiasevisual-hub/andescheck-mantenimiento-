-- =====================================================================
-- Corrige get_resultado_neto: precio_total en combustible_cargas es un
-- campo opcional que muchas cargas dejan vacío (solo cargan litros +
-- precio_unitario). Sumar solo precio_total subestimaba el combustible
-- del mes. Ahora, si falta, se calcula litros * precio_unitario.
-- =====================================================================
