-- ==== Fix: "rutinas vencidas" nunca se detectaban ====
-- rutinas_calculado.estado_calculado usa 'Vencida' (femenino: viene de
-- rutina/tarea). Varias funciones comparaban contra 'Vencido' (masculino,
-- correcto para documentos/OT pero no para rutinas) y por eso el dashboard,
-- la salud de flota y el KPI de la ficha del activo nunca contaban ninguna
-- rutina vencida aunque existieran.
...
begin
  ...
  return jsonb_build_object(
    ...
    'rutinas_vencidas', (select count(*) from rutinas_calculado where empresa_id = v_empresa and activo = true and estado_calculado = 'Vencida'),
