-- =====================================================================
-- Fix: get_dashboard() perdió el contador "unidades_operativas". Se había
-- agregado en fix_dashboard_disponibilidad_flota.sql, pero feature_combustible.sql
-- volvió a redefinir toda la función (create or replace pisa el cuerpo
-- entero) para sumar la cola de alertas de combustible, sin incluirlo.
-- Este archivo fusiona ambas versiones: cola con alertas de combustible +
-- contador de unidades operativas.
-- =====================================================================
