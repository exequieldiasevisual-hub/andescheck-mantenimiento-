-- ==== Fix: agregar unidades_total a get_dashboard ====
-- Para poder mostrar "Unidades activas" también como porcentaje, hace falta
-- un denominador distinto al de las demás tarjetas: el total de unidades
-- registradas (activas + inactivas), no solo las activas.
